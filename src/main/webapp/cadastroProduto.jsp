        ...
        <h1>Cadastrar Produto</h1>
         ...
         <div class="form-group">
                    <form action="CadastroProduto" method="POST">
                        <input type="text" name="base64" id="base64" value="${imagem.imagem1}" />
                        <input type="text" name="base642" id="base642" value="${imagem.imagem2}"/>
                        <input type="text" name="base643" id="base643" value="${imagem.imagem3}"/>
