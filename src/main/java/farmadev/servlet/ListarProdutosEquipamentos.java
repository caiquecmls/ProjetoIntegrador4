 ...
 * @author diego
 */
@WebServlet(name = "ListarProdutosEquipamentos", urlPatterns = {"/ListarProdutosEquipamentos"})
public class ListarProdutosEquipamentos extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
          ...
          String Filtro = request.getParameter("Filtro");
           List<Produto> produto = ProdutosDAO.listarProdutos("","EQUIPAMENTOS");
