...
public class ProdutosDAO {
    ...
    public static boolean update(Produto e, Imagem imagem, Perguntas pergunta1, Perguntas pergunta2, Perguntas pergunta3) {
        ...
        try {
            ...
            String sql
                    = //"update  PRODUTO set PRD_NOME='AAA' , PRD_DESCRICAO='AAA' , PRD_QUANTIDADE =10 , PRD_VALOR_UNIT =10 , PRD_CATEGORIA ='AAA',  PRD_PROMOCAO ='Sim' , PRD_DESCONTO ='10%' where PRD_ID=11 ;";
    ...
    public static List<Produto> BuscarProdutoscarrinho(int ID, List<Produto> produtos) {
        ...
        try {
            ...
            con = ConexaoDB.getConexao();
            String sql = " SELECT* FROM PRODUTO,IMAGENS where PRD_ID = IMG_PRD_ID and PRD_ID =" + ID + " GROUP BY PRD_ID;";
